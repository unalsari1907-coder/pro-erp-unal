// lib/screens/alis_siparisleri_screen.dart
...
class AlisSiparisleriScreen extends StatefulWidget {
  const AlisSiparisleriScreen({super.key});

  @override
  State<AlisSiparisleriScreen> createState() =>
      _AlisSiparisleriScreenState();
}

class _AlisSiparisleriScreenState
    extends State<AlisSiparisleriScreen> {
  ...
  Future<void> _verileriYukle() async {
    ...
    try {
      ...
      _mesaj(
        'Alış siparişleri yüklenemedi: $e',
        Colors.red,
      );
    }
  }
  ...
  Future<List<Map<String, dynamic>>>
    ...
    final response =
        await SupabaseService.supabase
            .from('alis_siparis_detay')
            .select(
              'detay_id, siparis_id, stok_id, miktar, '
              'kabul_edilen_miktar, kalan_miktar, birim_fiyat, '
                  ...
                  onPressed: snapshot.hasData && !_islemYapiliyor
                      ? () async {
                          try {
                            ...
                            if (mounted) {
                              _mesaj('Alış siparişi yazdırılamadı: $e', Colors.red);
                            }
                          }
                        }
                      : null,
  ...
  Future<void> _siparisiFaturala(
    ...
    if (secilebilirDetaylar.isEmpty) {
      _mesaj(
        'Bu alış siparişinde kabul edilecek kalan ürün yok.',
        Colors.orange,
      );
      return;
    }
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            ...
                            subtitle: Text(
                              ...
                              'Mevcut Stok: ${_sayi(detay['stok_miktari']).toStringAsFixed(0)}\n'
                              'Birim Alış: ${_para(detay['birim_fiyat'])}',
                            ),
                            trailing: SizedBox(
                              width: 130,
                              child: TextField(
                                controller:
                                    miktarControllerlari[
                                        detayId],
                                keyboardType:
                                    const TextInputType
                                        .numberWithOptions(
                  ...
                  onPressed: () {
                        ...
                        ScaffoldMessenger.of(
                          ...
                          SnackBar(
                            content: Text(
                              ...
                              'Kabul miktarı 0 ile kalan miktar arasında olmalıdır.',
                            ),
                            backgroundColor:
                                Colors.red,
                          ),
                    ...
                    if (kabuller.isEmpty) {
                      ScaffoldMessenger.of(
                        ...
                        const SnackBar(
                          content: Text(
                            'En az bir üründen kabul miktarı girin.',
                          ),
                          backgroundColor:
                              Colors.orange,
                        ),
    ...
    for (final controller
        in miktarControllerlari.values) {
      controller.dispose();
    }
    ...
    try {
      ...
      _mesaj(
        'Alış siparişi faturaya dönüştürüldü. '
        'Alış ID: $alisId',
        Colors.green,
      );
      ...
      _mesaj(
        'Alış siparişi faturalama hatası: $e',
        Colors.red,
      );
    } finally {
      if (mounted) {
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        Text(
                          'Ödeme: ${_metin(siparis['odeme_tipi'])}',
                        ),
                        Text(
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration:
                        InputDecoration(
                      hintText:
                          'Sipariş no, tedarikçi, depo, durum, ödeme tipi...',
                      prefixIcon:
                          const Icon(
                        Icons.search,
                      ),
